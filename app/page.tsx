			...
			<section className="relative py-20 px-4">
				<div className="max-w-6xl mx-auto text-center">
					...
					<p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
						Réservez des cours avec les meilleurs coaches de votre région. Paiements
						sécurisés via XRP Ledger avec système d'escrow intégré.
					</p>
					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="text-center">
							...
							<p className="text-gray-600">
								Tous nos coaches sont certifiés et ont été vérifiés par notre équipe
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								Système d'escrow sur XRP Ledger pour des transactions 100%
								sécurisées
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								Réservez vos cours en quelques clics, 24h/24 et 7j/7
							</p>
						</div>
					</div>
				</div>
