// cancel-xaman-payloads.ts
// Script TypeScript pour annuler plusieurs payloads Xaman/XUMM par UUID
import 'dotenv/config';
import { cancelPayload, getPayloadStatus } from './lib/services/xaman-backend';
